...
"[project]/node_modules/@replit/codemirror-vim/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ /** @arg {typeof import("./cm_adapter").CodeMirror} CM */ function initVim(CM) {
    /**
 ...
 */ var Pos = CM.Pos;
    /** @arg {CodeMirror} cm @arg {Pos} curStart @arg {Pos} curEnd */ function updateSelectionForSurrogateCharacters(cm, curStart, curEnd) {
    ...
    /** @type {import("./types").vimKeyMap} */ var defaultKeymap = [
   ...
   */ var langmap = parseLangmap('');
    /** @arg {CodeMirror} cm */ function enterVimMode(cm) {
    ...
    /** @arg {CodeMirror} cm */ function leaveVimMode(cm) {
    ...
    /** @arg {CodeMirrorV} cm */ function getOnPasteFn(cm) {
    ...
    /** @arg {CodeMirror} cm @arg {number} line */ function isLine(cm, line) {
        return line >= cm.firstLine() && line <= cm.lastLine();
    }
    /** @arg {string} k */ function isLowerCase(k) {
        return /^[a-z]$/.test(k);
    }
    /** @arg {string} k */ function isMatchableSymbol(k) {
        return '()[]{}'.indexOf(k) != -1;
    }
    /** @arg {string} k */ function isNumber(k) {
        return numberRegex.test(k);
    }
    /** @arg {string} k */ function isUpperCase(k) {
        return upperCaseChars.test(k);
    }
    /** @arg {string} k */ function isWhiteSpaceString(k) {
        return /^\s*$/.test(k);
    }
    /** @arg {string} k */ function isEndOfSentenceSymbol(k) {
        return '.?!'.indexOf(k) != -1;
    }
    /** @arg {any} val @arg {string | any[]} arr */ function inArray(val, arr) {
    ...
    /** @typedef {import("./types").vimOption} vimOption */ /** @type {Object<string, vimOption>} */ var options = {};
    /**
   * @overload
   * @arg {string} name 
   ...
   * @arg {any} value 
   * @arg {CodeMirrorV} [cm] 
   * @arg {{ scope?: any; } | undefined} [cfg] */ function setOption(name, value, cm, cfg) {
   ...
   * @arg {string} name 
   * @arg {CodeMirrorV} [cm] 
   * @arg {{ scope?: any; } | undefined} [cfg] */ function getOption(name, cm, cfg) {
        var option = options[name];
        cfg = cfg || {};
        var scope = cfg.scope;
        if (!option) {
    ...
    /** @arg {string|undefined} name @arg {CodeMirrorV} [cm] */ defineOption('filetype', undefined, 'string', [
        'ft'
    ], function(name, cm) {
    ...
    var createCircularJumpList = function() {
        ...
        /** @arg {CodeMirror} cm  @arg {Pos} oldCur @arg {Pos} newCur */ function add(cm, oldCur, newCur) {
            var current = pointer % size;
            var curMark = buffer[current];
            /** @arg {Pos} cursor */ function useNextSlot(cursor) {
        ...
        /** @arg {CodeMirror} cm  @arg {number} offset */ function move(cm, offset) {
            pointer += offset;
            if (pointer > head) {
                pointer = head;
        ...
        /** @arg {CodeMirror} cm @arg {number} offset */ function find(cm, offset) {
        ...
        return {
            /**@type{Pos|undefined} */ cachedCursor: undefined,
            add: add,
            find: find,
            move: move
        };
   ...
   */ var createInsertModeChanges = function(c) {
    ...
    class MacroModeState {
        constructor(){
            ...
            /** @type {string[]}*/ this.replaySearchQueries = [];
  ...
  */ var vimGlobalState;
    ...
    /** @type {number | undefined|false} */ var lastInsertModeKeyTimer;
    var vimApi = {
        ...
        /**@type {(lhs: string, rhs: string, ctx: string) => void} */ map: function(lhs, rhs, ctx) {
            // Add user defined key bindings.
            exCommandDispatcher.map(lhs, rhs, ctx);
        },
        /**@type {(lhs: string, ctx: string) => any} */ unmap: function(lhs, ctx) {
            return exCommandDispatcher.unmap(lhs, ctx);
        },
        // Non-recursive map function.
        // NOTE: This will not create mappings to key maps that aren't present
        // in the default key map. See TODO at bottom of function.
        /**@type {(lhs: string, rhs: string, ctx: string) => void} */ noremap: function(lhs, rhs, ctx) {
            exCommandDispatcher.map(lhs, rhs, ctx, true);
        },
        // Remove all user-defined mappings for the provided context.
        /**@arg {string} [ctx]} */ mapclear: function(ctx) {
        ...
        /**@type {(name: string, prefix: string|undefined, func: ExFn) => void} */ defineEx: function(name, prefix, func) {
            if (!prefix) {
                prefix = name;
        ...
        /**@type {(cm: CodeMirror, key: string, origin: string) => undefined | boolean} */ handleKey: function(cm, key, origin) {
     ...
     * returns true.
     */ /**@type {(cm_: CodeMirror, key: string, origin?: string| undefined) => (() => boolean|undefined) | undefined} */ findKey: function(cm_, key, origin) {
            ...
            if (command === false) {
                return !vim.insertMode && (key.length === 1 || CM.isMac && /<A-.>/.test(key)) ? function() {
                    return true;
                } : undefined;
        ...
        /**@type {(cm: CodeMirrorV, input: string)=>void} */ handleEx: function(cm, input) {
    ...
    var keyToKeyStack = [];
    var noremap = false;
    /**@type {undefined | null | import("./types").PromptOptions} */ var virtualPrompt;
    /**
   * @arg {string} key
   */ function sendKeyToPrompt(key) {
        ...
        /** @param {string | undefined} value */ function close(value) {
   ...
   */ function doKeyToKey(cm, keys, fromKey) {
    ...
    /**@type{Record<string, string>} */ var specialKey = {
        Return: 'CR',
        Backspace: 'BS',
        'Delete': 'Del',
        Escape: 'Esc',
   ...
   */ function parseLangmap(langmapString) {
        ...
        /** @arg {string} list */ function getEscaped(list) {
    ...
    /**@implements {InputStateInterface} */ class InputState {
        constructor(){
            /**@type{InputStateInterface["prefixRepeat"]} */ this.prefixRepeat = [];
            /**@type{InputStateInterface["motionRepeat"]} */ this.motionRepeat = [];
            /**@type{InputStateInterface["operator"]} */ this.operator = null;
            /**@type{InputStateInterface["operatorArgs"]} */ this.operatorArgs = null;
            /**@type{InputStateInterface["motion"]} */ this.motion = null;
            /**@type{InputStateInterface["motionArgs"]} */ this.motionArgs = null;
            /**@type{InputStateInterface["keyBuffer"]} */ this.keyBuffer = []; // For matching multi-key commands.
            /**@type{InputStateInterface["registerName"]} */ this.registerName = undefined; // Defaults to the unnamed register.
            /**@type{InputStateInterface["changeQueue"]} */ this.changeQueue = null; // For restoring text used by insert mode keybindings
        }
        /** @param {string} n */ pushRepeatDigit(n) {
            if (!this.operator) {
    ...
    /** @arg {CodeMirrorV} cm  @arg {string} [reason] */ function clearInputState(cm, reason) {
   ...
   */ class Register {
        /** @arg {string} [text] @arg {boolean} [linewise] @arg {boolean } [blockwise] */ constructor(text, linewise, blockwise){
            this.clear();
            this.keyBuffer = [
                text || ''
            ];
            /** @type {InsertModeChanges[]} */ this.insertModeChanges = [];
            /** @type {string[]}*/ this.searchQueries = [];
            this.linewise = !!linewise;
            this.blockwise = !!blockwise;
        }
        /** @arg {string} [text] @arg {boolean} [linewise] @arg {boolean } [blockwise] */ setText(text, linewise, blockwise) {
            this.keyBuffer = [
                text || ''
            ];
            this.linewise = !!linewise;
        ...
        /** @arg {string} text @arg {boolean} [linewise] */ pushText(text, linewise) {
        ...
        /** @arg {InsertModeChanges} changes */ pushInsertModeChanges(changes) {
            this.insertModeChanges.push(createInsertModeChanges(changes));
        }
        /** @arg {string} query */ pushSearchQuery(query) {
   ...
   */ class RegisterController {
        /** @arg {Object<string, Register>} registers */ constructor(registers){
     ...
     */ getRegister(name) {
        ...
        /**@type {{(name: any): name is string}} */ isValidRegister(name) {
    ...
    class HistoryController {
        constructor(){
            /**@type {string[]} */ this.historyBuffer = [];
            this.iterator = 0;
     ...
     */ nextMatch(input, up) {
        ...
        /** @arg {string} input */ pushInput(input) {
     ...
     */ processAction: function(cm, vim, command) {
        ...
        /** @arg {CodeMirrorV} cm @arg {vimState} vim @arg {import("./types").searchCommand} command*/ processSearch: function(cm, vim, command) {
            ...
            var lastQuery = "";
            /** @arg {string} query  @arg {boolean} ignoreCase  @arg {boolean} smartCase */ function handleQuery(query, ignoreCase, smartCase) {
            ...
            /** @arg {string} query */ function onPromptClose(query) {
       ...
       */ function onPromptKeyUp(e, query, close) {
            ...
            function onChange() {
                var parsedQuery;
                try {
                    parsedQuery = updateSearchQuery(cm, lastQuery, true, true);
                } catch (e) {
            ...
            /** @arg {KeyboardEvent} e  @arg {string} query  @arg {(arg0?: string) => void} close */ function onPromptKeyDown(e, query, close) {
     ...
     */ processEx: function(cm, vim, command) {
            /**@arg {string} input*/ function onPromptClose(input) {
       ...
       */ function onPromptKeyUp(e, query) {
            ...
            if (command.type == 'keyToEx') {
                ...
                /**@type{import("./types").PromptOptions} */ var promptOptions = {
                    onClose: onPromptClose,
                    onKeyDown: onPromptKeyDown,
                    onKeyUp: onPromptKeyUp,
                    prefix: ':'
        ...
        /**@arg {CodeMirrorV} cm   @arg {vimState} vim */ evalInput: function(cm, vim) {
            // If the motion command is set, execute both the operator and motion.
            // Otherwise return.
            var inputState = vim.inputState;
            var motion = inputState.motion;
            /** @type {MotionArgs}*/ var motionArgs = inputState.motionArgs || {
                repeat: 1
            };
            var operator = inputState.operator;
            /** @type {OperatorArgs}*/ var operatorArgs = inputState.operatorArgs || {};
        ...
        /**@arg {vimState} vim  @arg {InputStateInterface} inputState, @arg {import("./types").actionCommand} [actionCommand] */ recordLastEdit: function(vim, inputState, actionCommand) {
            var macroModeState = vimGlobalState.macroModeState;
            if (macroModeState.isPlaying) {
                return;
            }
   ...
   */ var motions = {
     ...
     */ findAndSelectNextInclusive: function(cm, _head, motionArgs, vim, prevInputState) {
        ...
        jumpToMark: function(cm, head, motionArgs, vim) {
            ...
            for(var i = 0; i < motionArgs.repeat; i++){
                ...
                for(var key in vim.marks){
                    ...
                    var isWrongDirection = motionArgs.forward ? // @ts-ignore
                    ...
                    var between = motionArgs.forward ? // @ts-ignore
                    cursorIsBetween(cursor, mark, best) : // @ts-ignore
        ...
        textObjectManipulation: function(cm, head, motionArgs, vim) {
            ...
            //     outside of a () block.
            /** @type{Object<string, string>} */ var mirroredPairs = {
                '(': ')',
                ')': '(',
                '{': '}',
                '}': '{',
            ...
            /** @type{Object<string, boolean>} */ var selfPaired = {
                '\'': true,
                '"': true,
                '`': true
            };
    ...
    /** @arg {string} name  @arg {import("./types").MotionFn} fn */ function defineMotion(name, fn) {
        motions[name] = fn;
    }
    /** @arg {string} val @arg {number} times */ function fillArray(val, times) {
        var arr = [];
   ...
   */ /** @type {import("./types").vimOperators} */ var operators = {
    ...
    /** @arg {string} name  @arg {import("./types").OperatorFn} fn */ function defineOperator(name, fn) {
        operators[name] = fn;
    }
    /** @type {import("./types").vimActions} */ var actions = {
    ...
    /** @arg {string } name  @arg {import("./types").ActionFn} fn */ function defineAction(name, fn) {
        actions[name] = fn;
    }
    /*
   ...
   */ function clipCursorToContent(cm, cur, oldCur) {
    ...
    /**@type <T>(args: T)=>T */ function copyArgs(args) {
        var ret = {};
   ...
   */ function commandMatches(keys, keyMap, context, inputState) {
    ...
    /** @arg {string} pressed  @arg {string} mapped  @return {'full'|'partial'|false}*/ function commandMatch(pressed, mapped) {
    ...
    /** @arg {string} keys */ function lastChar(keys) {
        var match = /^.*(<[^>]+>)$/.exec(keys);
    ...
    /** @arg {CodeMirror} cm   @arg {{ (cm: CodeMirror): void }} fn   @arg {number} repeat */ function repeatFn(cm, fn, repeat) {
        return function() {
    ...
    /** @arg {Pos} cur   @return {Pos}*/ function copyCursor(cur) {
        return new Pos(cur.line, cur.ch);
    }
    /** @arg {Pos} cur1 @arg {Pos} cur2  @return {boolean} */ function cursorEqual(cur1, cur2) {
        return cur1.ch == cur2.ch && cur1.line == cur2.line;
    }
    /** @arg {Pos} cur1  @arg {Pos} cur2 @return {boolean}*/ function cursorIsBefore(cur1, cur2) {
    ...
    /** @arg {Pos} cur1 @arg {Pos} cur2  @return {Pos}*/ function cursorMin(cur1, cur2) {
    ...
    /** @arg {Pos} cur1  @arg {Pos} cur2  @return {Pos} */ function cursorMax(cur1, cur2) {
        if (arguments.length > 2) {
            // @ts-ignore
    ...
    /** @arg {Pos} cur1   @arg {Pos} cur2  @arg {Pos} cur3  @return {boolean}*/ function cursorIsBetween(cur1, cur2, cur3) {
        // returns true if cur2 is between cur1 and cur3.
        var cur1before2 = cursorIsBefore(cur1, cur2);
        var cur2before3 = cursorIsBefore(cur2, cur3);
        return cur1before2 && cur2before3;
    }
    /** @arg {CodeMirror} cm  @arg {number} lineNum */ function lineLength(cm, lineNum) {
        return cm.getLine(lineNum).length;
    }
    /** @arg {string} s */ function trim(s) {
        if (s.trim) {
            return s.trim();
        }
        return s.replace(/^\s+|\s+$/g, '');
    }
    /** @arg {string} s */ function escapeRegex(s) {
        return s.replace(/([.?*+$\[\]\/\\(){}|\-])/g, '\\$1');
    }
    /** @arg {CodeMirror} cm  @arg {number} lineNum  @arg {number} column */ function extendLineToColumn(cm, lineNum, column) {
    ...
    /** @arg {CodeMirror} cm  @arg {Pos} selectionEnd */ function selectBlock(cm, selectionEnd) {
    ...
    /** @arg {CodeMirror} cm  @arg {any} head  @arg {number} height */ function selectForInsert(cm, head, height) {
        var sel = [];
    ...
    /** @arg {vimState["sel"][]} ranges  @arg {Pos} cursor  @arg {string | undefined} [end] */ function getIndex(ranges, cursor, end) {
        for(var i = 0; i < ranges.length; i++){
    ...
    /** @arg {CodeMirror} cm  @arg {vimState} vim  @return {[Pos,Pos]}*/ function getSelectedAreaRange(cm, vim) {
        var selections = cm.listSelections();
    ...
    /** @arg {CodeMirror} cm @arg {vimState} vim */ function updateLastSelection(cm, vim) {
        var anchor = vim.sel.anchor;
    ...
    /** @arg {CodeMirrorV} cm @arg {Pos} start @arg {Pos} end @arg {Boolean} [move] @returns {[Pos, Pos]} */ function expandSelection(cm, start, end, move) {
   ...
   */ function makeCmSelection(cm, sel, mode, exclusive) {
    ...
    /** @arg {CodeMirror} cm */ function getHead(cm) {
   ...
   */ function exitVisualMode(cm, moveHead) {
        ...
        vim.visualLine = false;
        vim.visualBlock = false;
        if (!vim.insertMode) CM.signal(cm, "vim-mode-change", {
            mode: "normal"
        });
    }
    /** 
   ...
   */ function clipToLine(cm, curStart, curEnd) {
    ...
    /** @arg {CodeMirror} _cm  @arg {Pos} curStart  @arg {Pos} curEnd */ function expandSelectionToLine(_cm, curStart, curEnd) {
        curStart.ch = 0;
        curEnd.ch = 0;
        curEnd.line++;
    }
    /** @arg {string} [text] */ function findFirstNonWhiteSpaceCharacter(text) {
        if (!text) {
            return 0;
        }
   ...
   */ function expandTagUnderCursor(cm, head, inclusive) {
    ...
    /** @arg {CodeMirror} cm @arg {Pos} oldCur @arg {Pos} newCur */ function recordJumpPosition(cm, oldCur, newCur) {
        if (!cursorEqual(oldCur, newCur)) {
            vimGlobalState.jumpList.add(cm, oldCur, newCur);
        }
    }
    /** @arg {number} increment  @arg {{ forward?: any; selectedCharacter?: any; }} args */ function recordLastCharacterSearch(increment, args) {
        vimGlobalState.lastCharacterSearch.increment = increment;
        vimGlobalState.lastCharacterSearch.forward = args.forward;
        vimGlobalState.lastCharacterSearch.selectedCharacter = args.selectedCharacter;
    }
    /**@type{Record<string, keyof findSymbolModes>} */ var symbolToMode = {
        '(': 'bracket',
        ')': 'bracket',
        '{': 'bracket',
        '}': 'bracket',
   ...
   * }>} */ var findSymbolModes = {
    ...
    /** @arg {CodeMirrorV} cm  @arg {number} repeat  @arg {boolean|undefined} forward  @arg {string} symb */ function findSymbol(cm, repeat, forward, symb) {
        var cur = copyCursor(cm.getCursor());
   ...
   * @arg {vimState} vim 
   * @arg {boolean} keepHPos */ function moveToEol(cm, head, motionArgs, vim, keepHPos) {
        var cur = head;
   ...
   */ function moveToCharacter(cm, repeat, forward, character, head) {
    ...
    /** @arg {CodeMirrorV} cm @arg {number} repeat */ function moveToColumn(cm, repeat) {
   ...
   * @arg {vimState} vim 
   * @arg {string} markName 
   * @arg {Pos} pos */ function updateMark(cm, vim, markName, pos) {
   ...
   * @arg {any} character 
   * @arg {boolean} [forward] 
   * @arg {boolean} [includeChar] */ function charIdxInLine(start, line, character, forward, includeChar) {
   ...
   * @arg {number} repeat 
   * @arg {number} dir 
   * @arg {boolean} [inclusive] */ function findParagraph(cm, head, repeat, dir, inclusive) {
        var line = head.line;
        var min = cm.firstLine();
        var max = cm.lastLine();
        var start, end, i = line;
        /** @arg {number} i */ function isEmpty(i) {
            return !cm.getLine(i);
        }
        /** @arg {number} i @arg {number} dir @arg {boolean} [any] */ function isBoundary(i, dir, any) {
            if (any) {
   ...
   */ function findSentence(cm, cur, repeat, dir) {
      ...
      */ /** @arg {CodeMirror} cm @arg {number} ln  @arg {number} pos  @arg {number} dir */ function forward(cm, ln, pos, dir) {
            var line = cm.getLine(ln);
            var stop = line === "";
            var curr = {
                line: line,
    ...
    /** @arg {CodeMirror} cm  @arg {Pos} head @arg {string | number} symb @arg {boolean} inclusive */ function selectCompanionObject(cm, head, symb, inclusive) {
        var cur = head;
        var bracketRegexp = {
            '(': /[()]/,
            ')': /[()]/,
    ...
    /** @arg {CodeMirror} cm  @arg {Pos} head  @arg {string} symb @arg {boolean} inclusive */ function findBeginningAndEnd(cm, head, symb, inclusive) {
    ...
    /**@type {SearchStateInterface} */ class SearchState {
        constructor(){
            /**@type{number|undefined} */ this.highlightTimeout;
        }
        getQuery() {
    ...
    /** @arg {string} argString */ function splitBySlash(argString) {
        return splitBySeparator(argString, '/');
    }
    /** @arg {string} argString */ function findUnescapedSlashes(argString) {
        return findUnescapedSeparators(argString, '/');
    }
    /** @arg {string} argString  @arg {string} separator */ function splitBySeparator(argString, separator) {
    ...
    /** @arg {string} str  @arg {string} separator */ function findUnescapedSeparators(str, separator) {
    ...
    /** @arg {string} str */ function translateRegex(str) {
    ...
    /** @type{Object<string, string>} */ var charUnescapes = {
        '\\n': '\n',
        '\\r': '\r',
        '\\t': '\t'
    };
    /** @arg {string} str */ function translateRegexReplace(str) {
        var escapeNextChar = false;
        var out = [];
    ...
    /** @type{Record<string, string>} */ var unescapes = {
        '\\/': '/',
        '\\\\': '\\',
        '\\n': '\n',
        '\\r': '\r',
    ...
    /** @arg {string} str */ function unescapeRegexReplace(str) {
   ...
   */ function dom(n) {
    ...
    /** @arg {CodeMirror} cm  @arg {any} template  @arg {boolean} [long]*/ function showConfirm(cm, template, long) {
        var pre = dom('div', {
            $color: 'red',
            $whiteSpace: 'pre',
            class: 'cm-vim-message'
    ...
    /** @arg {string|HTMLElement} prefix  @arg {string|HTMLElement} [desc] */ function makePrompt(prefix, desc) {
        return dom('div', {
            $display: 'flex',
            $flex: 1
        }, dom('span', {
   ...
   */ function showPrompt(cm, options) {
    ...
    /** @arg {RegExp|unknown} r1  @arg {RegExp|unknown} r2 */ function regexEqual(r1, r2) {
  ...
  */ function updateSearchQuery(cm, rawQuery, ignoreCase, smartCase) {
    ...
    /** @arg {RegExp} query */ function searchOverlay(query) {
    ...
    /** @arg {CodeMirrorV} cm  @arg {RegExp} query */ function highlightSearchMatches(cm, query) {
    ...
    /** @arg {CodeMirror} cm @arg {boolean} prev @arg {RegExp} query @arg {number | undefined} [repeat] */ function findNext(cm, prev, query, repeat) {
        return cm.operation(function() {
            if (repeat === undefined) {
                repeat = 1;
            }
            ...
            for(var i = 0; i < repeat; i++){
                ...
                if (!found) {
                    ...
                    cursor = cm.getSearchCursor(query, // @ts-ignore
   ...
   */ function findNextFromAndToInclusive(cm, prev, query, repeat, vim) {
    ...
    /** @arg {CodeMirrorV} cm */ function clearSearchHighlight(cm) {
        var state = getSearchState(cm);
   ...
   */ function isInRange(pos, start, end) {
    ...
    /** @arg {CodeMirror} cm */ function getUserVisibleLines(cm) {
    ...
    /** @arg {CodeMirror} cm @arg {vimState} vim  @arg {string} markName */ function getMarkPos(cm, vim, markName) {
    ...
    /** @arg {CodeMirror} cm */ function getLastEditPos(cm) {
    ...
    class ExCommandDispatcher {
        constructor(){
            /**@type {Record<string, import("./types").exCommandDefinition>} */ this.commandMap_;
     ...
     */ parseInput_(cm, inputStream, result) {
            ...
            if (commandMatch) {
                ...
                result.commandName = (inputStream.match(/.*/) || [
                    ""
                ])[0];
            }
            return result;
     ...
     */ matchCommand_(commandName) {
        ...
        /**@type {(lhs: string, rhs: string, ctx: string|void, noremap?: boolean) => void} */ map(lhs, rhs, ctx, noremap) {
            if (lhs != ':' && lhs.charAt(0) == ':') {
                if (ctx) {
        ...
        /**@type {(lhs: string, ctx: string) => boolean|void} */ unmap(lhs, ctx) {
            if (lhs != ':' && lhs.charAt(0) == ':') {
    ...
    /** @typedef { import("./types").ExParams} ExParams */ var exCommands = {
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ colorscheme: function(cm, params) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params @arg {'insert'|'normal'|string} [ctx] @arg {boolean} [defaultOnly]*/ map: function(cm, params, ctx, defaultOnly) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ imap: function(cm, params) {
            this.map(cm, params, 'insert');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ nmap: function(cm, params) {
            this.map(cm, params, 'normal');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ vmap: function(cm, params) {
            this.map(cm, params, 'visual');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ omap: function(cm, params) {
            this.map(cm, params, 'operatorPending');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ noremap: function(cm, params) {
            this.map(cm, params, undefined, true);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ inoremap: function(cm, params) {
            this.map(cm, params, 'insert', true);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ nnoremap: function(cm, params) {
            this.map(cm, params, 'normal', true);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ vnoremap: function(cm, params) {
            this.map(cm, params, 'visual', true);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ onoremap: function(cm, params) {
            this.map(cm, params, 'operatorPending', true);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params @arg {string} ctx*/ unmap: function(cm, params, ctx) {
            var mapArgs = params.args;
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ mapclear: function(cm, params) {
            vimApi.mapclear();
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ imapclear: function(cm, params) {
            vimApi.mapclear('insert');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ nmapclear: function(cm, params) {
            vimApi.mapclear('normal');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ vmapclear: function(cm, params) {
            vimApi.mapclear('visual');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ omapclear: function(cm, params) {
            vimApi.mapclear('operatorPending');
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ move: function(cm, params) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ set: function(cm, params) {
            ...
            /**@type {string|boolean|undefined} */ var value = expr.length > 0 ? expr.join('=') : undefined;
            var forceGet = false;
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ setlocal: function(cm, params) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ setglobal: function(cm, params) {
            // setCfg is passed through to setOption
            params.setCfg = {
                scope: 'global'
            };
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ registers: function(cm, params) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ marks: function(cm, params) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ sort: function(cm, params) {
            ...
            /** @arg {string} a  @arg {string} b */ function compareFn(a, b) {
                if (reverse) {
                    var tmp;
                    tmp = a;
                    a = b;
            ...
            /** @arg {string[]} a  @arg {string[]} b */ function comparePatternFn(a, b) {
                if (reverse) {
                    var tmp;
                    tmp = a;
                    a = b;
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ vglobal: function(cm, params) {
            // global inspects params.commandName
            this.global(cm, params);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ normal: function(cm, params) {
            var noremap = false;
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ global: function(cm, params) {
            ...
            /**@type {(string|import("./types").LineHandle)[]}*/ var matchedLines = [];
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ substitute: function(cm, params) {
            if (!cm.getSearchCursor) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ startinsert: function(cm, params) {
            doKeyToKey(cm, params.argString == '!' ? 'A' : 'i', {});
        },
        redo: CM.commands.redo,
        undo: CM.commands.undo,
        /** @arg {CodeMirrorV} cm */ write: function(cm) {
            if (CM.commands.save) {
                CM.commands.save(cm);
            } else if (cm.save) {
        ...
        /** @arg {CodeMirrorV} cm */ nohlsearch: function(cm) {
            clearSearchHighlight(cm);
        },
        /** @arg {CodeMirrorV} cm */ yank: function(cm) {
            var cur = copyCursor(cm.getCursor());
            var line = cur.line;
            var lineText = cm.getLine(line);
            vimGlobalState.registerController.pushText('0', 'yank', lineText, true, true);
        },
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ delete: function(cm, params) {
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ join: function(cm, params) {
            var line = params.selectionLine;
            var lineEnd = isNaN(params.selectionLineEnd) ? line : params.selectionLineEnd;
        ...
        /** @arg {CodeMirrorV} cm @arg {ExParams} params*/ delmarks: function(cm, params) {
   ...
   */ function doReplace(cm, confirm, global, lineStart, lineEnd, searchCursor, query, replaceWith, callback) {
        ...
        /** @arg {(() => void) | undefined} [close] */ function stop(close) {
            if (close) {
                close();
            }
            cm.focus();
            ...
            if (callback) {
                ...
                showConfirm(cm, (matches ? 'Found ' + matches + ' matches' : 'No matches found') + ' for pattern: ' + query + (getOption('pcre') ? ' (set nopcre to use Vim regexps)' : ''));
            }
        }
        /** @arg {KeyboardEvent} e   @arg {any} _value   @arg {any} close */ function onPromptKeyDown(e, _value, close) {
            // Swallow all keys.
            CM.e_stop(e);
            var keyName = vimKeyFromEvent(e);
            switch(keyName){
    ...
    /** @arg {CodeMirrorV} cm  @arg {boolean} [keepCursor] */ function exitInsertMode(cm, keepCursor) {
        var vim = cm.state.vim;
        var macroModeState = vimGlobalState.macroModeState;
    ...
    /** @arg {vimKey} command*/ function _mapCommand(command) {
        defaultKeymap.unshift(command);
        if (command.keys) addUsedKeys(command.keys);
    }
    /** @arg {string} keys */ function addUsedKeys(keys) {
    ...
    /** @arg {string} keys */ function removeUsedKeys(keys) {
        keys.split(/(<(?:[CSMA]-)*\w+>|.)/i).forEach(function(part) {
   ...
   */ function executeMacroRegister(cm, vim, macroModeState, registerName) {
    ...
    /** @arg {MacroModeState} macroModeState @arg {any} key */ function logKey(macroModeState, key) {
        if (macroModeState.isPlaying) {
            return;
        }
    ...
    /** @arg {MacroModeState} macroModeState */ function logInsertModeChange(macroModeState) {
        if (macroModeState.isPlaying) {
            return;
        }
        var registerName = macroModeState.latestRegister;
    ...
    /** @arg {MacroModeState} macroModeState @arg {string} query */ function logSearchQuery(macroModeState, query) {
        if (macroModeState.isPlaying) {
            return;
        }
        var registerName = macroModeState.latestRegister;
   ...
   */ function onCursorActivity(cm) {
    ...
    /** @arg {CodeMirrorV} cm  @arg {vimState} vim */ function handleExternalSelection(cm, vim) {
   ...
   */ function repeatLastEdit(cm, vim, repeat, repeatForInsert) {
        ...
        /** @arg {number} repeat */ function repeatInsert(repeat) {
    ...
    /**@arg {CodeMirrorV} cm, @arg {string} key */ function sendCmKey(cm, key) {
   ...
   */ function repeatInsertModeChanges(cm, changes, repeat) {
    ...
    // multiselect support
    /** @arg {vimState} state */ function cloneVimState(state) {
        // @ts-ignore
    ...
    /** @arg {CodeMirror} cm_  @arg {string} key @arg {string} origin */ function multiSelectHandleKey(cm_, key, origin) {
        var vim = maybeInitVimState(cm_);
        var cm = cm_;
        /** @type {boolean | undefined} */ var isHandled = false;
...
function runHistoryCommand(cm, revert) {
    ...
    (revert ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undo"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redo"])(cm.cm6);
...
var keys = {
    Left: (cm)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runScopeHandlers"])(cm.cm6, {
            key: "Left"
        }, "editor"),
    Right: (cm)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runScopeHandlers"])(cm.cm6, {
            key: "Right"
        }, "editor"),
    Up: (cm)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runScopeHandlers"])(cm.cm6, {
            key: "Up"
        }, "editor"),
    Down: (cm)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runScopeHandlers"])(cm.cm6, {
            key: "Down"
        }, "editor"),
    Backspace: (cm)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runScopeHandlers"])(cm.cm6, {
            key: "Backspace"
        }, "editor"),
    Delete: (cm)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runScopeHandlers"])(cm.cm6, {
            key: "Delete"
        }, "editor")
};
class CodeMirror {
    ...
    foldCode(pos) {
        ...
        let tmpRanges = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].create([
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].range(index, index)
        ], 0).ranges;
        view.state.selection.ranges = tmpRanges;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["foldCode"])(view);
    ...
    setSelections(p, primIndex) {
        ...
        var ranges = p.map((x)=>{
            ...
            if (head == anchor) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(head, 1);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].range(anchor, head);
        });
        this.cm6.dispatch({
            selection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].create(ranges, primIndex)
        });
    }
    ...
    getLineNumber(handle) {
        ...
        for(var i = 0; i < updates.length; i++){
            offset = updates[i].changes.mapPos(offset, 1, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MapMode"].TrackAfter);
    ...
    setValue(text) {
        ...
        return cm.dispatch({
            ...
            selection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].range(0, 0)
        });
    }
    focus() {
    ...
    findMatchingBracket(pos, _options) {
        ...
        var m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchBrackets"])(state, offset + 1, -1);
        if (m && m.end) {
            return {
                to: posFromIndex(state.doc, m.end.from)
            };
        }
        m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchBrackets"])(state, offset, 1);
        if (m && m.end) {
            return {
                to: posFromIndex(state.doc, m.end.from)
            };
    ...
    indentMore() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indentMore"])(this.cm6);
    }
    indentLess() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indentLess"])(this.cm6);
    }
    execCommand(name) {
        if (name == "indentAuto") CodeMirror.commands.indentAuto(this);
        else if (name == "goLineLeft") (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cursorLineBoundaryBackward"])(this.cm6);
        else if (name == "goLineRight") {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cursorLineBoundaryForward"])(this.cm6);
            let state = this.cm6.state;
            let cur = state.selection.main.head;
            if (cur < state.doc.length && state.sliceDoc(cur, cur + 1) !== "\n") {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cursorCharBackward"])(this.cm6);
            }
    ...
    addOverlay({ query }) {
        let cm6Query = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$search$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SearchQuery"]({
            regexp: true,
            search: query.source,
        ...
        if (cm6Query.valid) {
            ...
            let effect = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$search$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSearchQuery"].of(cm6Query);
            this.cm6.dispatch({
                effects: effect
            });
            return cm6Query;
    ...
    removeOverlay(overlay) {
        ...
        let effect = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$search$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSearchQuery"].of(this.cm6Query);
        this.cm6.dispatch({
            effects: effect
        });
    }
    getSearchCursor(query, pos) {
        ...
        function rCursor(doc, from = 0, to = doc.length) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$search$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RegExpCursor"](doc, source, {
    ...
    findPosV(start, amount, unit, goalColumn) {
        ...
        let range = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(startOffset, 1, undefined, goalColumn);
    ...
    scrollIntoView(pos, margin) {
        if (pos) {
            ...
            this.cm6.dispatch({
                effects: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"].scrollIntoView(offset)
            });
        } else {
            this.cm6.dispatch({
                scrollIntoView: true,
    ...
    getOption(name) {
        switch(name){
            ...
            case "indentWithTabs":
                return this.cm6.state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indentUnit"]) == "\t"; // TODO
            case "indentUnit":
                return this.cm6.state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indentUnit"]).length || 2;
            case "textwidth":
    ...
    getTokenTypeAt(pos) {
        ...
        var offset = this.indexFromPos(pos);
        var tree = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ensureSyntaxTree"])(this.cm6.state, offset);
    ...
    overWriteSelection(text) {
        ...
        var ranges = sel.ranges.map((x)=>{
            if (x.empty) {
                ...
                if (ch && !/\n/.test(ch)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].range(x.from, x.to + 1);
            }
            return x;
        });
        this.cm6.dispatch({
            selection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].create(ranges, sel.mainIndex)
        });
        this.replaceSelection(text);
    }
    /*** multiselect ****/ isInMultiSelectMode() {
    ...
    forEachSelection(command) {
        ...
        this.virtualSelection = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].create(selection.ranges, selection.mainIndex);
        for(var i = 0; i < this.virtualSelection.ranges.length; i++){
            var range = this.virtualSelection.ranges[i];
            if (!range) continue;
            this.cm6.dispatch({
                selection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorSelection"].create([
                    range
                ])
            });
            command();
...
// --------------------------
CodeMirror.Pos = Pos;
CodeMirror.StringStream = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StringStream"];
CodeMirror.commands = {
    cursorCharLeft: function(cm) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cursorCharLeft"])(cm.cm6);
    },
    redo: function(cm) {
    ...
    newlineAndIndent: function(cm) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["insertNewlineAndIndent"])({
            state: cm.cm6.state,
            dispatch: (tr)=>{
    ...
    indentAuto: function(cm) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indentSelection"])(cm.cm6);
    },
...
/************* dialog *************/ function dialogDiv(cm, template, bottom) {
...
function findEnclosingTag(cm, pos) {
    ...
    var tree = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$language$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ensureSyntaxTree"])(state, offset);
...
class Marker {
    ...
    update(change) {
        if (this.offset != null) this.offset = change.mapPos(this.offset, this.assoc, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MapMode"].TrackDel);
    }
}
...
let getDrawSelectionConfig = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDrawSelectionConfig"] || /*@__PURE__*/ function() {
    let defaultConfig = {
...
const hideNativeSelection = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Prec"].highest(/*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"].theme(themeSpec));
function getBase(view) {
    let rect = view.scrollDOM.getBoundingClientRect();
    let left = view.textDirection == __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Direction"].LTR ? rect.left : rect.right - view.scrollDOM.clientWidth;
    return {
...
const vimStyle = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"].baseTheme({
...
const vimPlugin = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewPlugin"].fromClass(class {
    constructor(view){
        this.status = "";
        this.query = null;
    ...
    update(update) {
        ...
        if (update.transactions) {
            for (let tr of update.transactions)for (let effect of tr.effects){
                if (effect.is(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$search$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSearchQuery"])) {
    ...
    updateClass() {
        ...
        if (!state.vim || state.vim.insertMode && !state.overwrite) this.view.scrollDOM.classList.remove("cm-vimMode");
    ...
    highlight(query) {
        this.query = query;
        if (!query) return this.decorations = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].none;
        let { view } = this;
    ...
    provide: ()=>{
        return [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"].inputHandler.of((view, from, to, text)=>{
                var _a, _b;
                var cm = getCM(view);
                if (!cm) return false;
...
const showVimPanel = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateEffect"].define();
const vimPanelState = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateField"].define({
    create: ()=>false,
    update (value, tr) {
    ...
    provide: (f)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showPanel"].from(f, (on)=>on ? createVimPanel : null);
    }
});
...
function vim(options = {}) {
    return [
        ...
        vimPlugin,
        hideNativeSelection,
        options.status ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showPanel"].of(statusPanel) : vimPanelState
    ];
}
function getCM(view) {
    return view.cm || null;
...
//# sourceMappingURL=node_modules_%40replit_codemirror-vim_dist_index_0l9ypo0.js.map